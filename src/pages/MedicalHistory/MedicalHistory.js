        ...
        return <>
                <div>
                    ...
                    <div className="internalSection space">
                        <label className='styleTitle fijar'>Historia Clínica</label>
                        <div className='container'>
                            ...
                            >
                                <div class="flex flex-row-reverse md:contents"> 
                                    <div
                                        class="bg-stone-50 col-start-2 col-end-3 p-4 rounded-xl my-4 ml-auto shadow-md"
                                    >
                                ...
                                <div class="flex md:contents">
                                    <div class="col-start-3 col-end-4 mr-10 md:mx-auto relative">
                                    ...
                                    <div
                                        class="bg-stone-50 col-start-4 col-end-8 p-4 rounded-xl my-4 mr-auto shadow-md"
                                    >
                                ...
                                <div class="flex md:contents">
                                    ...
                                    <div
                                        class="bg-stone-50 col-start-4 col-end-8 p-4 rounded-xl my-4 mr-auto shadow-md w-80"
                                    >
